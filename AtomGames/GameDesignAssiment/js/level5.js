var level5State = {
  ...
  create: function() {
    ...
    game.global.bossLives = game.global.bossMaxLives;

    game.global.currentLvl = 5;
    ...
    platform1 = platforms.create(125, 525, "platform");
    platform1.width = 150;

    platform2 = platforms.create(0, 425, "platform");
    platform2.width = 150;

    platform3 = platforms.create(250, 425, "platform");
    platform3.width = 150;

    platform4 = platforms.create(125, 325, "platform");
    platform4.width = 150;


    platform5 = platforms.create(930, 525, "platform");
    platform5.width = 150;

    platform6 = platforms.create(1050, 425, "platform");
    platform6.width = 150;

    platform7 = platforms.create(800, 425, "platform");
    platform7.width = 150;

    platform8 = platforms.create(930, 325, "platform");
    platform8.width = 150;

    platform9 = platforms.create(400, 220, "platform");
    platform9.width = 400;
    ...
    boss = bosss.create(600, 400, "boss");
    ...
    boss.animations.add('right', [4, 5, 6], 10, true);
    boss.animations.add('stop', [3], 10, true);

    // create boss health bar
    bosshealthBar = game.add.image(game.world.width - 700, 100, "healthbar");
    bosshealthBar.anchor.setTo(0, 0);
    bosshealthBar.width = game.global.bossLives / game.global.bossMaxLives * 200;

    // create the cyborg
    cyborgs = game.add.group();
    cyborgs.enableBody = true;

    cyborg = cyborgs.create(175, 225, "zombie");
    cyborg.health = 3;
    ...
    cyborg = cyborgs.create(1000, 225, "zombie");
    cyborg.health = 3;
    game.physics.arcade.enable(cyborg);
    cyborg.body.gravity.y = 300;
    cyborg.body.bounce.y = 0.2;
    ...
    cyborg = cyborgs.create(500, 150, "zombie");
    cyborg.health = 3;
    game.physics.arcade.enable(cyborg);
    cyborg.body.gravity.y = 300;
    cyborg.body.bounce.y = 0.2;
    ...
    cyborg = cyborgs.create(700, 150, "zombie");
    cyborg.health = 3;
    game.physics.arcade.enable(cyborg);
    cyborg.body.gravity.y = 300;
    cyborg.body.bounce.y = 0.2;
    ...
    // create Boss health
    bossHealthText = game.add.text(525, 50, "Boss Health", {});
    ...
    // first bounch
    explosiveBarrel = explosiveBarrels.create(615, 150, "explosiveBarrel");
    explosiveBarrel.body.gravity.y = 8;
    explosiveBarrel.body.drag.x = 1000;
    explosiveBarrel.body.collideWorldBounds = true;

    explosiveBarrel = explosiveBarrels.create(585, 150, "explosiveBarrel");
    explosiveBarrel.body.gravity.y = 8;
    explosiveBarrel.body.drag.x = 1000;
    explosiveBarrel.body.collideWorldBounds = true;

    explosiveBarrel = explosiveBarrels.create(600, 120, "explosiveBarrel");
    explosiveBarrel.body.gravity.y = 8;
    explosiveBarrel.body.drag.x = 1000;
    explosiveBarrel.body.collideWorldBounds = true;

    // secound bunch
    explosiveBarrel = explosiveBarrels.create(350, 600, "explosiveBarrel");
    explosiveBarrel.body.gravity.y = 8;
    explosiveBarrel.body.drag.x = 1000;
    explosiveBarrel.body.collideWorldBounds = true;

    explosiveBarrel = explosiveBarrels.create(380, 600, "explosiveBarrel");
    explosiveBarrel.body.gravity.y = 8;
    explosiveBarrel.body.drag.x = 1000;
    explosiveBarrel.body.collideWorldBounds = true;

    explosiveBarrel = explosiveBarrels.create(365, 570, "explosiveBarrel");
    explosiveBarrel.body.gravity.y = 8;
    explosiveBarrel.body.drag.x = 1000;
    explosiveBarrel.body.collideWorldBounds = true;

    // third Bunch
    explosiveBarrel = explosiveBarrels.create(800, 600, "explosiveBarrel");
    explosiveBarrel.body.gravity.y = 8;
    explosiveBarrel.body.drag.x = 1000;
    explosiveBarrel.body.collideWorldBounds = true;

    explosiveBarrel = explosiveBarrels.create(830, 600, "explosiveBarrel");
    explosiveBarrel.body.gravity.y = 8;
    explosiveBarrel.body.drag.x = 1000;
    explosiveBarrel.body.collideWorldBounds = true;

    explosiveBarrel = explosiveBarrels.create(815, 570, "explosiveBarrel");
    explosiveBarrel.body.gravity.y = 8;
    explosiveBarrel.body.drag.x = 1000;
    explosiveBarrel.body.collideWorldBounds = true;
    ...
    explosiveBarrel = explosiveBarrels.create(300, 375, "explosiveBarrel");
    explosiveBarrel.body.gravity.y = 8;
    explosiveBarrel.body.drag.x = 1000;
    explosiveBarrel.body.collideWorldBounds = true;

    explosiveBarrel = explosiveBarrels.create(850, 375, "explosiveBarrel");
    explosiveBarrel.body.gravity.y = 8;
    explosiveBarrel.body.drag.x = 1000;
    explosiveBarrel.body.collideWorldBounds = true;
  ...
  update: function() {
    ...
    game.physics.arcade.collide(bosss, platforms);
    game.physics.arcade.overlap(player, cyborgs, this.cyborgHitPlayer);
    game.physics.arcade.overlap(player, bosss, this.bossHitPlayer);
    ...
    game.physics.arcade.overlap(bosss, weapon.bullets, this.bosshitwithbullet);
    ...
    game.physics.arcade.collide(explosiveBarrels, bosss);
    ...
    game.physics.arcade.collide(cyborgs, cyborgs);
    game.physics.arcade.collide(explosiveBarrels, explosiveBarrels);
    ...
    //     level5State.collectHealthPickup();
    //   }
    // }
    ...
    var distanceBossX = player.x - boss.x;
    var distanceBossY = player.y - boss.y;
    if ((distanceBossX < 0 && distanceBossX > -400) && (distanceBossY < 350 && distanceBossY > -350)) {
      boss.body.velocity.x = -70;
      boss.animations.play("left");
    } else if ((distanceBossX > 0 && distanceBossX < 400) && (distanceBossY < 350 && distanceBossY > -350)) {
      boss.body.velocity.x = 70;
      boss.animations.play("right");
    } else {
      boss.body.velocity.x = 0;
      boss.animations.play("stop");
    }
  },
    ...
    if (game.global.hasGun == true && game.global.isReloading == false && game.global.ammoInGun != 30) {
      ...
      game.time.events.add(1000, () => {
        if ((game.global.ammoInGun + game.global.ammoInBag) >= 30) {
          ...
          game.global.ammoInGun += game.global.ammoInBag;
          game.global.ammoInBag = 0;
        }
        ammoText.text = "Ammo: " + game.global.ammoInGun + "/" + game.global.ammoInBag;
  ...
  bossRemoveLives: function(boss, bullet, lives) {
    bullet.kill();
    game.global.bossLives -= lives;
    if (game.global.bossLives <= 0) {
      // kill boss and create portal
      boss.kill();
      portal = portals.create(boss.x + 35, boss.y + 65, "portal");
    } else {
      bosshealthBar.width = game.global.bossLives / game.global.bossMaxLives * 200;
    }

    if (game.global.bossLives == 150) {
      level5State.spawnZombiesFromBoss();
    } else if (game.global.bossLives == 100) {
      level5State.spawnZombiesFromBoss();
    } else if (game.global.bossLives == 50) {
      level5State.spawnZombiesFromBoss();
    }
  },
  ...
  bulletHitExplosiveBarrel: function(bullet, explosiveBarrel) {
    ...
    if (distance1X < 100 && distance1Y < 125) {
      level5State.cyborghit(cyborg, bullet, 3);
    }
  });

  var distance3X = Math.abs(explosiveBarrel.x - boss.x);
  var distance3Y = Math.abs(explosiveBarrel.y - boss.y);
  if (distance3X < 100 && distance3Y < 125) {
    level5State.bossRemoveLives(cyborg, bullet, 10)
  }
  ...
  collectHealthPickup: function() {
    if (game.global.lives != 10) {
      ...
      // give player health
      level5State.addLives(3);
    }
  },

  cyborghitwithbullet: function(cyborg, bullet) {
    level5State.cyborghit(cyborg, bullet, 1);
  },

  bosshitwithbullet: function(boss, bullet) {
    level5State.bossRemoveLives(boss, bullet, 1);
  },
  ...
  spawnZombiesFromBoss: function() {
    for (i = 0; i < 5; i++) {
      cyborg = cyborgs.create((game.rnd.integerInRange(-100, 100) + boss.x), boss.y, "zombie");
      cyborg.health = 3;
      game.physics.arcade.enable(cyborg);
      cyborg.body.gravity.y = 300;
      cyborg.body.bounce.y = 0.2;
