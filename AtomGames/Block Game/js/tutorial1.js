var tutorial1State = {
   create: function() {
    ...
    // create text
    titleText = game.add.text(game.world.centerX, game.world.centerY - 200, 'There are diffrent types of orbs which all do diffrent things.');
    titleText.anchor.setTo(0.5, 0.5);
    // create Jump Boost Text
    jumpBoostText = game.add.text(game.world.centerX, game.world.centerY, 'This is a warp orb it warps you to the next level.');
    jumpBoostText.anchor.setTo(0.5, 0.5);
    ...
    warp = warps.create(500, 505, "warp");
