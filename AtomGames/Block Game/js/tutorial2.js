var tutorial2State = {
   create: function() {
    ...
    // create text
    jumpBoostText = game.add.text(game.world.centerX, game.world.centerY - 200, 'This is a jump orb it makes you jump high.');
    ...
    // create jump orb
    jumpBoosts = game.add.group();
    jumpBoosts.enableBody = true;
    jumpBoost = jumpBoosts.create(500, 505, "jumpBoost");
  ...
  jumpBoost: function() {
   ...
   update: function() {
      ...
      game.physics.arcade.overlap(player, jumpBoosts, this.jumpBoost);
      //move player
      if (left.isDown) {
