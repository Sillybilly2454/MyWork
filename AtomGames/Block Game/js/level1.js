var level1State = {
   create: function() {
    ...
    game.time.events.loop(Phaser.Timer.QUARTER, this.updateTimer, this);
  },


  updateTimer: function() {
    game.global.currentTime += 0.250;
  },
  ...
  warp: function() {
    if (game.global.currentTime < game.global.level1BestTime) {
      game.global.level1BestTime = game.global.currentTime;
    } else if (game.global.level1BestTime == 0) {
      game.global.level1BestTime = game.global.currentTime;
    }
